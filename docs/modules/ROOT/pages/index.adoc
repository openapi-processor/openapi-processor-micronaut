...
openapi-processor-micronaut doesn't have micronaut specific documentation so far. Follow the xref:spring::index.adoc[openapi-processor-spring] documentation. Most of it is valid for the micronaut processor. Just replace the Spring Boot annotation with the Micronaut annotations.
